...
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports { Carry }]; #IO_L18P_T2_A12_D28_14 Sch=led[7]
...
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { Cin }]; #IO_L4N_T0_D05_14 Sch=btnu
